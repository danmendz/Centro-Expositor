...
<nav class="navbar" style="background: #FFA800; border-bottom: 2px solid #000000">
  ...
  <div class='admin_options_and_overview'>
    <div class='left_border_box'>
      ...
      <div class="dropdownOptions">
        <button class="category">Eventos</button>
          <div class="dropdown-content">
            ...
            <a href='evento/index.php' data-page='evento/index.php'>Mis eventos</a>
      ...
      <div class="dropdownOptions">
        <button class="category">Invitados</button>
          <div class="dropdown-content">
            <a href='invitados/pendientes.php' data-page='invitados/pendientes.php'>Pendientes</a>
            <a href='invitados/aprobados.php' data-page='invitados/aprobados.php'>Aprobados</a>
          </div>
      </div>
      ...
      <div class="dropdownOptions">
        <button class="category">Estacionamiento</button>
          <div class="dropdown-content">
            <a href='estacionamiento/areas/asignadas.php' data-page='estacionamiento/areas/asignadas.php'>Areas asignadas</a>
