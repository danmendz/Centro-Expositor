...
$invitados = $invitado->listaPendientes($id_cliente);
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <table class="table table-striped">
    ...
    <tr>
        ...
        <td align="center">
          ...
          <a href="" onClick="confirma('rechazar.php?id_evento=<?=$invitado->evento_id ?>&id_persona=<?=$invitado->persona_id ?>'); return false;" title='Rechazar invitado'><i class="bi bi-trash3"></i></a>
          <a href="aprobar.php?id_evento=<?=$invitado->evento_id ?>&id_persona=<?=$invitado->persona_id ?>" title='Aprobar invitado'><i class="bi bi-check-lg"></i></a>&nbsp;
        </td>
    </tr>
    <?php
    }
