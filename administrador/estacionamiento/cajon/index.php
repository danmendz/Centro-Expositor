...
<body>
  ...
  <div class="form-group">
    <a href="insertar.php" class="btn btn-success"><i class="bi bi-plus-circle"></i>Registrar nuevo cajon</a>
  </div>
  <table>
    <tr>
      <td>
  ...
  ?>
      <div style="width: 100px; height: 100px; background-color: <?=$color ?>; display: inline-block; margin: 5px;  margin-bottom: 30px;">
          <h1><?= $cajon->numero ?></h1>
          <a href="modificar.php?id=<?=$cajon->id ?>"><input type="button" name="Modificar" title="Modificar cajon"></a>
      </div>
  <?php
  }
  ?>
