...
<div class="container py-2">
  ...
  <table class="table table-striped">
    <tr>
        ...
        <td align="center"><b>ID de evento</b></td>
    ...
    <tr>
        ...
        <td align="center"><span title="<?=$reserva->id_evento?>"><?=$reserva->id_evento?></span></td>
        ...
        <td align="center">
          ...
          <a href="insertar.php?id_evento=<?=$reserva->id_evento?>" title='Aprobar reserva'><i class="bi bi-check-lg"></i></a>&nbsp;
        </td>
    </tr>
    <?php
    }
